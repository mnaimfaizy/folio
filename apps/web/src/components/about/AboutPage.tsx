    ...
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          ...
          community for over {settings.about_years_service || '30+'} years.
        </p>
      </div>
            ...
            {!settings.about_history_text && (
              <>
                ...
                <p>
                  ...
                  information and promoting literacy. In 2010, we launched our
                  first digital catalog, and in 2018, we completely renovated
                  our main building to create more collaborative spaces.
                </p>
                <p>
                  Our library has been recognized for excellence in community
                  service, innovative programming, and our commitment to digital
                  inclusion. We continue to evolve with the changing needs of
                  our community while preserving the joy of reading and
                  discovery that has always been at our core.
                </p>
              </>
            )}
          </div>
