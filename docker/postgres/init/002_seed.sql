...
INSERT INTO books (title, isbn, publish_year, author, description)
VALUES
  ('To Kill a Mockingbird', '9780061120084', 1960, 'Harper Lee', 'A classic novel of justice and morality.'),
  ('1984', '9780451524935', 1949, 'George Orwell', 'A dystopian novel about surveillance and power.'),
  ('The Great Gatsby', '9780743273565', 1925, 'F. Scott Fitzgerald', 'A novel of wealth, love, and the American Dream.')
